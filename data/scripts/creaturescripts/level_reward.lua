local table = 
{
	...
	[30] = {type = "bank", id = {50000, 0}, msg = "Was deposited in your bank 50000 gold coins!"},
	[40] = {type = "addon", id = {136, 128}, msg = "You win the addon citizen full for reach the level 40!"},
	[50] = {type = "coin", id = {10, 0}, msg = "You win 10 coins for reach the level 50!"},
	[60] = {type = "mount", id = {15, 0}, msg = "You win the mount Uniwheel!"},
}
